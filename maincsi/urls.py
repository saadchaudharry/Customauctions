...
from product.views import (Category_list,product_list,product_detail,formjsjs,paytm,handlerequest,contactuss)

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', Category_list.as_view(),name="index"),
    path('1', formjsjs,name="indfdfex"),
    path('contactus/', contactuss.as_view(),name="contactsss"),
